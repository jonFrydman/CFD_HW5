...
void writeGrid(){
	...
	fout.close();
		...
		fout << "VARIABLES = \"X\", \"Y\", \"xSnorm\",\"ySnorm\",\"xWnorm\", \"yWnorm\", \"xSds\", \"ySds\","; 
		fout <<" \"xWds\", \"yWds\", \"xInorm\", \"yInorm\", \"xJnorm\", \"yJnorm\" \n";
		fout << "ZONE T = \"Grid center vals" << " \", I = " << grd.N - 1 << " , J = " << grd.M - 1 << ", F=POINT \n\n";
		for (int j = 0; j < grd.M - 1; j++) {
			for (int i = 0; i < grd.N - 1; i++) {
